              ...
              return (
                ...
                >
                  {imageSrc ? (
                    ...
                    >
                      {/* BG decoration */}
                      <div className="absolute inset-0 flex items-center justify-center opacity-[0.12] group-hover:opacity-[0.2] transition-opacity select-none">
                        {post.audioId ? (
                          <div className="flex items-end justify-center gap-1 w-full px-4 h-1/2">
                            {[...Array(10)].map((_, i) => (
                              <div
                                key={i}
